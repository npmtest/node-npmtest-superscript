...
<div class="header medium">
    ...
    <h2>
        ...
        Statements: <span class="metric">62.18% <small>(74 / 119)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        ...
        Lines: <span class="metric">62.39% <small>(73 / 117)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
...
&nbsp;
    ...
    this.scope = options.scope || <span class="branch-1 cbranch-no" title="branch not covered" >{};</span>
&nbsp;
    // Built-in plugins
    this.loadPlugins(`${__dirname}/../plugins`);
&nbsp;
    // For user plugins
    <span class="missing-if-branch" title="else path not taken" >E</span>if (options.pluginsPath) {
      this.loadPlugins(options.pluginsPath);
    }
&nbsp;
    <span class="missing-if-branch" title="if path not taken" >I</span>if (options.messagePluginsPath) {
...
&nbsp;
     ...
     */
    <span class="missing-if-branch" title="if path not taken" >I</span>if (options.useMultitenancy) {
<span class="cstat-no" title="statement not covered" >      return callback(null, instance);</span>
    }
&nbsp;
    const bot = instance.getBot('master');
    <span class="missing-if-branch" title="else path not taken" >E</span>if (options.importFile) {
      return bot.importFile(options.importFile, err =&gt; <span class="cstat-no" title="statement not covered" >callback(err, bot))</span>;
    }
